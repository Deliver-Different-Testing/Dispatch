...
>
> **Before building §3, run Q6/Q7 and Q14** (§7). They decide whether this is a view-only change or a view change plus a data fix, and whether `CourierFuel` is populated enough to bind to.
>
